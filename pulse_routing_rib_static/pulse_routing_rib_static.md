...
Atribute|Details
---:|:---
**KPI Name**    | RIB static route count
**KPI ID**      | `pulse_routing_rib_static`
...
Atribute|Details
---:|:---
**Subscription** | Cisco-IOS-XR-ip-rib-ipv4-oper:rib/vrfs/vrf/afs/af/safs/saf/ip-rib-route-table-names/ip-rib-route-table-name/protocol/static/non-as/information
...
* ### `pulse_routing_rib_static_routecount`
Atribute|Details
---:|:---
**Alert ID**             | ```pulse_routing_rib_static_routecount```
...
* ### `pulse_routing_rib_static_routememory`
Atribute|Details
---:|:---
**Alert ID**             | ```pulse_routing_rib_static_routememory```
**Data Filter Logic**    | ```lambda: TRUE```
