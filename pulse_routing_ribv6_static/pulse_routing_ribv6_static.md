...
Atribute|Details
---:|:---
**KPI Name**    | RIBv6 static route count
**KPI ID**      | `pulse_routing_ribv6_static`
...
Atribute|Details
---:|:---
**Subscription** | Cisco-IOS-XR-ip-rib-ipv6-oper:ipv6-rib/vrfs/vrf/afs/af/safs/saf/ip-rib-route-table-names/ip-rib-route-table-name/protocol/static/non-as/information
...
* ### `pulse_routing_ribv6_static_routecount`
Atribute|Details
---:|:---
**Alert ID**             | ```pulse_routing_ribv6_static_routecount```
...
* ### `pulse_routing_ribv6_static_routememory`
Atribute|Details
---:|:---
**Alert ID**             | ```pulse_routing_ribv6_static_routememory```
**Data Filter Logic**    | ```lambda: TRUE```
