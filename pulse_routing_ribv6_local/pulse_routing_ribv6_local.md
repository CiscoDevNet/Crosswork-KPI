...
Atribute|Details
---:|:---
**KPI Name**    | RIBv6 local route count
**KPI ID**      | `pulse_routing_ribv6_local`
...
* ### `pulse_routing_ribv6_local_routecount`
Atribute|Details
---:|:---
**Alert ID**             | ```pulse_routing_ribv6_local_routecount```
...
* ### `pulse_routing_ribv6_local_routememory`
Atribute|Details
---:|:---
**Alert ID**             | ```pulse_routing_ribv6_local_routememory```
**Data Filter Logic**    | ```lambda: TRUE```
